...
class HBS_CL_LINE extends BaseModelDB2
{
    ...
    {
        return $this->hasMany('App\HBS_CL_LINE_REJ', 'clli_oid', 'clli_oid')->where('scma_oid_cl_rej_code','like','%CL_REJ_CODE_%');
    }

    public function  HBS_CL_CLAIM()
    {
        return $this->belongsTo('App\HBS_CL_CLAIM', 'clam_oid', 'clam_oid');
    }
}
