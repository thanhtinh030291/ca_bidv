...
Route::group(['prefix' => 'admin'], function () {
    Route::group(['middleware' => ['auth']], function(){
        ...
        Route::resource('render_claim', 'RenderClaimController');
        //GOP
        ...
        Route::get('/claim/barcode/{barcode}', 'ClaimController@barcode_link')->name('claim.barcode_link');
        ...
        Route::post('import_treatment', 'CSVController@import_treatment')->name('import_treatment')->middleware(['role:Admin']);
        ...
        Route::post('/searchMember', 'AjaxCommonController@searchMember')->name('searchMember');
        Route::get('/getPocyRefNo', 'AjaxCommonController@getPocyRefNo')->name('getPocyRefNo');
        Route::post('/getMemberInfo', 'AjaxCommonController@getMemberInfo')->name('getMemberInfo');
        Route::post('/getRelToHosp', 'AjaxCommonController@getRelToHosp')->name('getRelToHosp');
        Route::post('/sendClaimHBS', 'AjaxCommonController@sendClaimHBS')->name('sendClaimHBS');
        Route::post('/createClaimDB', 'AjaxCommonController@createClaimDB')->name('createClaimDB');
